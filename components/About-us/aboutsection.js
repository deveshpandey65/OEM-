        ...
        <section className="bg-white py-16 px-4 md:px-10 lg:px-20">
            <div className="flex flex-col lg:flex-row items-center gap-12 max-w-7xl mx-auto">
                ...
                <motion.div
                    ...
                    <div className="relative w-full max-w-[500px] aspect-[6/5] rounded-[20px] overflow-hidden shadow-lg">
                        {/* Orange background behind the image */}
                        <div className="absolute inset-0 left-0 w-1/2 bg-[#ffa633] z-0 rounded-[15px]" />
                        ...
                        {/* Image */}
                        <img
                            src="https://dreamsrent.dreamstechnologies.com/html/template/assets/img/about-us.png"
                            alt="about"
                ...
                <motion.div
                    ...
                    <p className="text-gray-600 mb-4 text-sm sm:text-base">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim minim veniam, quis nostrud exercitation ullamco laboris nisi esse cillum dolore eu fugiat nulla pariatur.
                    </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-700">
                        {[
                            "At vero et accusamus iusto dignissimos",
