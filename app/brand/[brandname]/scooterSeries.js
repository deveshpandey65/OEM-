...
import {scooters} from './bikes';

export default function ScooterSeries({brand}) {
    return (
        <div className="w-full mb-4 md:max-w-xs bg-white rounded-xl shadow-md p-4">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">{brand.toUpperCase()} Scooter Series</h2>
